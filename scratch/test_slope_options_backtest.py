...
from services.backtester import execute_slope_options_backtest

print("Testing execute_slope_options_backtest(period='1m', slope_period='2w')...")
res = execute_slope_options_backtest(period="1m", slope_period="2w")
